...
class _LocalAndWebObjectsWidgetState extends State<LocalAndWebObjectsWidget> {
  ...
  void onARViewCreated(
    ...
    /*_downloadFile("https://github.com/figonzal1/ar_files/raw/main/Duck.glb",
        "LocalDuck.glb");*/
  }
  ...
  Future<void> onLocalObjectAtOriginButtonPressed() async {
    if (this.localObjectNode != null) {
      ...
      var newNode = ARNode(
          ...
          uri: "Models/Chicken_01/my_locker.gltf",
  ...
  Future<void> onFileSystemObjectAtOriginButtonPressed() async {
    if (this.fileSystemNode != null) {
      ...
      var newNode = ARNode(
          ...
          uri:
              "https://github.com/figonzal1/ar_files/raw/main/locker.glb",
          scale: Vector3(0.2, 0.2, 0.2));
